  ...
  customElements.define(
    ...
    class extends HTMLElement {
      ...
      togglePopover(event) {
        ...
        (((this.mql.matches && !isExpanded) || event.type === "click") &&
          ...
          button.getAttribute("aria-expanded") === "true" &&
            ...
            button.addEventListener("keyup", (e) => {
              e.key === "Escape" && this.closePopover(e);
            })));
      }
      closePopover(event) {
        event.preventDefault();
...
//# sourceMappingURL=/cdn/shop/t/121/assets/quantity-popover.js.map?v=987015268078116491728527448
