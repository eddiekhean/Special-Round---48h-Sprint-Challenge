    ...
    class extends HTMLElement {
      ...
      update(variant) {
        variant?.available
          ...
          : (this.removeAttribute("available"), (this.innerHTML = ""));
      }
      renderError() {
        ((this.innerHTML = ""),
      ...
      renderPreview(sectionInnerHTML) {
        ...
        ((this.innerHTML = sectionInnerHTML.querySelector(
          ...
          this.dataset.productPageColorScheme
            .split(" ")
            .forEach((colorClass) => {
              document
...
//# sourceMappingURL=/cdn/shop/t/121/assets/pickup-availability.js.map?v=78418059211521962961728527448
